...
class TestSortingAlgo(unittest.TestCase):
    ...
    def test_two_pivot_block_partitioning(self):
        ...
        output1 = two_pivot_block_partitioning(arr1, 0, len(arr1) - 1, 2)
        self.assertEqual(output1, expected_output1)

        # Test case 2
        arr2 = [1, 2, 3, 4, 5]
        expected_output2 = (0, 4)
        output2 = two_pivot_block_partitioning(arr2, 0, len(arr2) - 1, 2)
        self.assertEqual(output2, expected_output2)

        # Test case 3
        arr3 = [5, 4, 3, 2, 1]
        expected_output3 = (0, 4)
        output3 = two_pivot_block_partitioning(arr3, 0, len(arr3) - 1, 2)
        self.assertEqual(output3, expected_output3)

        # Test case 4
        arr4 = [1]
        expected_output4 = (0, 0)
        output4 = two_pivot_block_partitioning(arr4, 0, len(arr4) - 1, 2)
        self.assertEqual(output4, expected_output4)

        # Test case 5
        arr5 = []
        expected_output5 = (0, 0)
        output5 = two_pivot_block_partitioning(arr5, 0, len(arr5) - 1, 2)
